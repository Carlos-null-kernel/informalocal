...
var arquivos = [
  "/Local/Publico/Aeroporto/arq.json", 
  "/Local/Publico/Bombeiros/arq.json", 
  "/Local/Publico/Escolas-Colegio/Estadual/arq.json",
  "/Local/Publico/Escolas-Colegio/Municipal/arq.json", 
  "/Local/Publico/Escolas-Colegio/arq.json",
  "/Local/Privado/Escolas-Colegio/arq.json",
  "/Local/Privado/Saude/Clinica-medica/arq.json",
  "/Local/Privado/Supermercados/arq.json",
  "/Local/Publico/Hospitais/arq.json",
  "/Local/Publico/Policia/arq.json",
  "/Local/Publico/loteria-loterica/arq.json",
  "/Local/Privado/Contabilidade/arq.json",
  "/Local/Privado/Corretora-de-Seguros/arq.json",
  "/Local/Privado/Corretor-de-imoves/arq.json",
  "/Local/Privado/Restaurante/arq.json",
  "/Local/Privado/Pizzaria/arq.json",
  "/Local/Privado/Saude/Farmacia/arq.json",
  "/Local/Privado/Saude/Estudio-de-Pilates/arq.json",
  "/Local/Privado/Saude/Hospitais/arq.json",
  "/Local/Privado/Lojas/Roupas/arq.json",
  "/Local/Privado/Automotiva/Mecanica/arq.json",
  "/Local/Privado/Auto-Escola/arq.json",
  "/Local/Privado/Posto-de-abastecimento/arq.json",
  "/Local/Privado/Automotiva/martelinho-de-ouro/arq.json",
  "/Local/Privado/Comidas-e-bebidas/drinks/arq.json",
  "/Local/Privado/Comidas-e-bebidas/brunch-dining/arq.json",
  "/Local/Privado/Servicos-Agricolas/arq.json",
  "/Local/Privado/Empresa-de-Montagem-Industrial/arq.json",
  "/Local/Privado/Hotel/arq.json",
  "/Local/Privado/Lojas/Moveis-e-Eletro/arq.json",
  "/Local/Publico/Escolas-Colegio/Municipal/Creche/arq.json",
  "/Local/Publico/Unidade-de-Saude/arq.json",
  "/Local/Publico/Secretaria-Municipal/arq.json",
  "/Local/Privado/Saude/Academia/arq.json"
];
...
function loadItems() {
  ...
  const shuffledArquivos = shuffle(arquivos);

  Promise.all(shuffledArquivos.map(arquivo =>
    fetch(arquivo).then(response => response.json())
  )).then(resultados => {
    items = resultados.flat();
    displayItems();
  });
}
